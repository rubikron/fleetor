...
Not every good idea belongs in your future. Some things need to end so your true vision can live. Pruning isn’t a loss—it’s preparation.
Ask yourself: What in this fleet’s work no longer fits the future being built?
...
Date it, Detail it, Develop it, Deadline it, and Daily devote to it.
...
If the leader is uninspired, so is the team.
...
Don’t interpret resistance as a reason to quit. It might just be the soil where your strength is cultivated.

7. Impact Happens When Vision Moves from “ME” to “WE” — how can I improve myself and the team around me
...
Make the workers want to be better — the vision is only attainable by a fleet that wants to be better.
