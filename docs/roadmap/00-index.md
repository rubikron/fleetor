...
| 27 | `27-reopening-a-run.md` | Reopening a run — History becomes a session switcher | 11, 25 | L | **not-started** — designed on branch `redesign/history`, decisions R0–R15, [visual guide](https://claude.ai/code/artifact/5b6ff072-faeb-49cf-9372-73bd41f0776c). Four vertical slices S1–S4; two vendor spikes (live spend) gate S1 |
